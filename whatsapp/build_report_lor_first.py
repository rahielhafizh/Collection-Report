...
def send_first_report_lor():
    logger.info("INITIATING EXCEL REPORT LOR FOR FIRST REPORT")
    ...
    switch_to_first_cells()
    close_unsave()
    logger.info("AUTOMATION FOR FIRST REPORT LOR WAS COMPLETED")


if __name__ == "__main__":
    logger.info(">> INITIALIZING AUTOMATION PROCESS FOR FIRST REPORT LOR")
