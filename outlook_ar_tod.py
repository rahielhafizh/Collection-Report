...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START SUMMARY PERFORMANCE AR REPORT MAIL")
    ...
    try:
        ...
        minimize_outlook()
        logger.info("[SYSTEM] SUMMARY PERFORMANCE AR REPORT MAIL COMPETED")

    except Exception as e:
        logger.error(f"[ERROR] SUMMARY PERFORMANCE AR REPORT MAIL FAILED : {e}")
        raise
