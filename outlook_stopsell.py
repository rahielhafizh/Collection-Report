...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START STOPSELL REPORT REPORT MAIL")
    ...
    try:
        ...
        minimize_outlook()
        logger.info("[SYSTEM] STOPSELL REPORT REPORT MAIL COMPETED")

    except Exception as e:
        logger.error(f"[ERROR] STOPSELL REPORT REPORT MAIL FAILED : {e}")
        raise
