...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START MOBCOLL LOR REPORT MAIL")
    ...
    try:
        ...
        minimize_outlook()
        logger.info("[SYSTEM] MOBCOLL LOR REPORT MAIL COMPETED")

    except Exception as e:
        logger.error(f"[ERROR] MOBCOLL LOR REPORT MAIL FAILED : {e}")
        raise
