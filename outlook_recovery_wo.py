...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START DASHBOARD CWO REPORT REPORT MAIL")
    ...
    try:
        ...
        minimize_outlook()
        logger.info("[SYSTEM] DASHBOARD CWO REPORT REPORT MAIL COMPETED")

    except Exception as e:
        logger.error(f"[ERROR] DASHBOARD CWO REPORT REPORT MAIL FAILED : {e}")
        raise
