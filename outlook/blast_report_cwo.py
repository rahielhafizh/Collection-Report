...
from services.remover_report_cwo import clear_submission_folder
from services.config import load_config, wait_timer, logger, get_month_id
from outlook_report_cwo import send_outlook_email
...
if __name__ == "__main__":
    ...
    clear_submission_folder(target_folder=CONFIG["SUBMISSION_DASHBOARD_CWO"])
    wait_timer(CONFIG["WAIT_TIME"]["ONE_SECOND"])
