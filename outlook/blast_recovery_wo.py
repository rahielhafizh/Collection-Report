...
from services.remover_recovery_wo import clear_submission_folder
from services.config import load_config, wait_timer, logger, get_month_id
from outlook_recovery_wo import send_outlook_email
...
if __name__ == "__main__":
    ...
    clear_submission_folder(target_folder=CONFIG["SUBMISSION_RECOVERY_WO"])
    wait_timer(CONFIG["WAIT_TIME"]["ONE_SECOND"])
