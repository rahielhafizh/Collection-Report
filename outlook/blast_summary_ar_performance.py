...
from services.cleaner.clean_summary_ar_performance import clean_path
...
from services.mailer.outlook_summary_ar_performance import send_outlook_email
...
if __name__ == "__main__":
    ...
    stop_keeper()
    wait_timer(CONFIG["WAIT_TIME"]["ONE_SECOND"])
    clean_path(target_folder=CONFIG["SUBMISSION_PERFORMANCE"])
    wait_timer(CONFIG["WAIT_TIME"]["ONE_SECOND"])
